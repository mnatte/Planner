...
namespace MvcApplication1.DataAccess
{
    public class DeliverableRepository : SimpleCrudRepository<ReleaseModels.Deliverable, DeliverableInputModel>
    {
        ...
        protected override void AddUpsertCommandParameters(DeliverableInputModel model, System.Data.SqlClient.SqlCommand cmd)
        {
            ...
            cmd.Parameters.Add("@OwnerId", System.Data.SqlDbType.Int).Value = model.OwnerId;
            cmd.Parameters.Add("@InitialHoursEstimate", System.Data.SqlDbType.Int).Value = model.InitialHoursEstimate;
            cmd.Parameters.Add("@FunctionId", System.Data.SqlDbType.Int).Value = model.HoursRemaining;
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
        }

        protected override ReleaseModels.Deliverable CreateItemByDbRow(System.Data.SqlClient.SqlDataReader reader)
        {
            var item = new ReleaseModels.Deliverable { Id = int.Parse(reader["Id"].ToString()), Title = reader["Title"].ToString(), Description = reader["Description"].ToString(), Location = reader["Location"].ToString(), HoursRemaining = int.Parse(reader["Initials"].ToString()), InitialHoursEstimate = int.Parse(reader["Initials"].ToString()), Format = reader["Format"].ToString() };
