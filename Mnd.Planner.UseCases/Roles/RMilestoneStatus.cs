...
namespace Mnd.Planner.UseCases.Roles
{
    public static class RMilestoneStatusImplementations
    {
        ...
        /// <summary>
        /// To be used when only datapoints are available.
        /// This line does not genereate a full velocity line to end of period
        /// </summary>
        /// <param name="ms"></param>
        ...
        #region Workload per day and artefact
