...
{
    public static class RMilestoneScheduleImplementations
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static void Plan(this RMilestoneSchedule evt, DateTime date, string time)
        {
            ...
            try
            {
                using (conn)
                {
                    ...
                    var cmd = new SqlCommand("sp_update_milestone_planning", conn);
